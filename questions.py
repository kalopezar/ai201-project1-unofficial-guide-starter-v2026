...
QUESTIONS = [
    ...
    {
        "question": "What is the latest week when I can declare a course pass/fail?",
        "expects": "week eight",
    },
    {
    ...
    {
        "question": "What happens to my GPA if I withdraw from a course by the deadline?",
        "expects": "doesn't affect GPA",
    },
    {
